...
\lstinputlisting[
  language={Python},
  caption={Слой взаимодейстия с pyswip}
]{../src/prolog.py}
...
\lstinputlisting[
  language={Python},
  caption={Парсер частного случая выражения на Prolog}
]{../src/parse.py}
...
\lstinputlisting[
  language={Python},
  caption={Слой принятия и обработки текстовых запросов}
]{../src/feedback.py}
...
\lstinputlisting[
  language={Python},
  caption={Фаззинг-тесты для чат-бота}
]{../src/test_fuzzing.py}

\subsection{Пример вывода программы}

\lstinputlisting[
  caption={Пример диалога с чат-ботом}
]{../res/example.txt}
